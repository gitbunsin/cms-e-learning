...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
   ...
   <!-- CSS -->
    <link rel="stylesheet" href="./job-details.blade_files/bootstrap.min.css">
    <link rel="stylesheet" href="./job-details.blade_files/font-awesome.min.css">
	<link rel="stylesheet" href="./job-details.blade_files/icofont.css"> 
    <link rel="stylesheet" href="./job-details.blade_files/slidr.css">     
    <link rel="stylesheet" href="./job-details.blade_files/main.css">  
	<link id="preset" rel="stylesheet" href="./job-details.blade_files/preset1.css">	
    <link rel="stylesheet" href="./job-details.blade_files/responsive.css">
	
	<!-- font -->
	<link href="./job-details.blade_files/css" rel="stylesheet" type="text/css">
	<link href="./job-details.blade_files/css(1)" rel="stylesheet" type="text/css">
  ...
  <body>
		...
		<nav class="navbar navbar-default">
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="https://demo.themeregion.com/jobs-updated/index.html"><img class="img-responsive" src="./job-details.blade_files/logo.png" alt="Logo"></a>
				</div>
				<!-- /navbar-header -->
				...
				<div class="navbar-left">
					<div class="collapse navbar-collapse" id="navbar-collapse">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="https://demo.themeregion.com/jobs-updated/details.html">Job Details</a></li>
				...
				<div class="nav-right">				
					...
					<a href="https://demo.themeregion.com/jobs-updated/post.html" class="btn">Post Your Job</a>
				</div>
				<!-- nav-right -->
			</div><!-- container -->
		</nav><!-- navbar -->
			...
			<div class="banner-form banner-form-full job-list-form">
				<form action="https://demo.themeregion.com/jobs-updated/job-details.html#">
					...
					<div class="dropdown category-dropdown">						
						<a data-toggle="dropdown" href="https://demo.themeregion.com/jobs-updated/job-details.html#"><span class="change-text">Job Category</span> <i class="fa fa-angle-down"></i></a>
						<ul class="dropdown-menu category-change">
							<li><a href="https://demo.themeregion.com/jobs-updated/job-details.html#">Customer Service</a></li>
							<li><a href="https://demo.themeregion.com/jobs-updated/job-details.html#">Software Engineer</a></li>
							<li><a href="https://demo.themeregion.com/jobs-updated/job-details.html#">Program Development</a></li>
							<li><a href="https://demo.themeregion.com/jobs-updated/job-details.html#">Project Manager</a></li>
							<li><a href="https://demo.themeregion.com/jobs-updated/job-details.html#">Graphics Designer</a></li>
						</ul>								
					</div><!-- category-change -->
					
					<!-- language-dropdown -->
					<div class="dropdown category-dropdown language-dropdown">
						<a data-toggle="dropdown" href="https://demo.themeregion.com/jobs-updated/job-details.html#"><span class="change-text">Job Location</span> <i class="fa fa-angle-down"></i></a>
						<ul class="dropdown-menu category-change language-change">
							<li><a href="https://demo.themeregion.com/jobs-updated/job-details.html#">Location 1</a></li>
							<li><a href="https://demo.themeregion.com/jobs-updated/job-details.html#">Location 2</a></li>
							<li><a href="https://demo.themeregion.com/jobs-updated/job-details.html#">Location 3</a></li>
						</ul>								
					...
					<div class="item-info">
						<div class="item-image-box">
							<div class="item-image">
								<img src="./job-details.blade_files/4.png" alt="Image" class="img-responsive">
							</div><!-- item-image -->
						</div>

						<div class="ad-info">
							<span><span><a href="https://demo.themeregion.com/jobs-updated/job-details.html#" class="title">Human Resource Manager</a></span> @ <a href="https://demo.themeregion.com/jobs-updated/job-details.html#"> Dropbox Inc</a></span>
							<div class="ad-meta">
								<ul>
						...
						<div class="col-sm-4">
							<div class="section job-short-info">
								...
								<ul>
									...
									<li><span class="icon"><i class="fa fa-user-plus" aria-hidden="true"></i></span> Job poster: <a href="https://demo.themeregion.com/jobs-updated/job-details.html#">Lance Ladaga</a></li>
									<li><span class="icon"><i class="fa fa-industry" aria-hidden="true"></i></span>Industry: <a href="https://demo.themeregion.com/jobs-updated/job-details.html#">Marketing and Advertising</a></li>
									<li><span class="icon"><i class="fa fa-line-chart" aria-hidden="true"></i></span>Experience: <a href="https://demo.themeregion.com/jobs-updated/job-details.html#">Entry level</a></li>
							...
							<div class="section company-info">
								<h1>Company Info</h1>
								<ul>
									<li>Compnay Name: <a href="https://demo.themeregion.com/jobs-updated/job-details.html#">Dropbox Inc</a></li>
									<li>Address: London, United Kingdom</li>
									<li>Compnay SIze:  2k Employee</li>
									<li>Industry: <a href="https://demo.themeregion.com/jobs-updated/job-details.html#">Technology</a></li>
									<li>Phone: +1234 567 8910</li>
									<li>Email: <a href="https://demo.themeregion.com/jobs-updated/job-details.html#">info@dropbox.com</a></li>
									<li>Website: <a href="https://demo.themeregion.com/jobs-updated/job-details.html#">www.dropbox.com</a></li>
								</ul>
								<ul class="share-social">
									<li><a href="https://demo.themeregion.com/jobs-updated/job-details.html#"><i class="fa fa-facebook-official" aria-hidden="true"></i></a></li>
									<li><a href="https://demo.themeregion.com/jobs-updated/job-details.html#"><i class="fa fa-twitter-square" aria-hidden="true"></i></a></li>
    ...
    <!-- JS -->
    <script async="" src="./job-details.blade_files/analytics.js.download"></script><script src="./job-details.blade_files/jquery.min.js.download"></script>
    <script src="./job-details.blade_files/bootstrap.min.js.download"></script>
    <script src="./job-details.blade_files/price-range.js.download"></script>   
    <script src="./job-details.blade_files/main.js.download"></script>
	<script src="./job-details.blade_files/switcher.js.download"></script>
	<script>
