...
class JobTitleController extends Controller
{
    ...
    {
        $job = JobCategory::all();
        return view('backend.Recruiment.JobCategory.index',compact('job'));
    }
    ...
    {
        //
        return view('backend.Recruiment.JobCategory.create');
    }
    ...
    public function show($id)
    {
       ...
       return view('backend.Recruiment.JobCategory.');
    }
    ...
    public function edit($id)
    {
        ...
        //dd($jobs);
        return view('backend.Recruiment.JobCategory.edit', compact('jobs', 'id'));
    }
    /**
