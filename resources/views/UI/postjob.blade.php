                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active"><a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">Pages<span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="https://demo.themeregion.com/jobs-updated/post.html">Job Post</a></li>
...
<!-- JS -->
<script async="" src="./PostJob_files/analytics.js.download"></script><script src="./PostJob_files/jquery.min.js.download"></script>
<script src="./PostJob_files/bootstrap.min.js.download"></script>
<script src="./PostJob_files/price-range.js.download"></script>
<script src="./PostJob_files/main.js.download"></script>
<script src="./PostJob_files/switcher.js.download"></script>
<script>
