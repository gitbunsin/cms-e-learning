                                                    ...
                                                    <div id="myCarousel" class="carousel fade profile-carousel">
                                                        ...
                                                        <div class="carousel-inner">
                                                            ...
                                                            <div class="item active">
                                                                <img src="http://localhost:8000/img/s1.jpg" alt="demo user">
                                                            </div>
                                                            <!-- Slide 2 -->
                                                            <div class="item">
                                                                <img src="http://localhost:8000/img/s1.jpg" alt="demo user">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3 profile-pic">
                                                            <img src="http://localhost:8000/img/avatars/sunny.png" alt="demo user">
                                                        ...
                                                        <div class="col-sm-3">
                                                            ...
                                                            <ul class="list-inline friends-list">
                                                                <li><img src="http://localhost:8000/img/avatars/sunny.png" alt="friend-1">
                                                                </li>
                                                                <li><img src="http://localhost:8000/img/avatars/sunny.png" alt="friend-2">
                                                                </li>
                                                                <li><img src="http://localhost:8000/img/avatars/sunny.png" alt="friend-3">
                                                                </li>
                                                                <li><img src="http://localhost:8000/img/avatars/sunny.png" alt="friend-4">
                                                                </li>
                                                                <li><img src="http://localhost:8000/img/avatars/sunny.png" alt="friend-5">
                                                                </li>
                                                                <li><img src="http://localhost:8000/img/avatars/sunny.png" alt="friend-6">
                                                                </li>
                                                                <li>
                                                        ...
                                                        <div class="tab-content padding-top-10">
                                                            ...
                                                            <div class="tab-pane fade" id="a2">
                                                                ...
                                                                <div class="user" title="email@company.com">
                                                                    <img src="http://localhost:8000/img/avatars/sunny.png" alt="demo user"><a href="javascript:void(0);">Jenn Wilson</a>
                                                                    <div class="email">
                                                                        travis@company.com
                                                                    </div>
                                                                </div>
                                                                <div class="user" title="email@company.com">
                                                                    <img src="http://localhost:8000/img/avatars/sunny.png" alt="demo user"><a href="javascript:void(0);">Marshall Hitt</a>
                                                                    <div class="email">
                                                                        marshall@company.com
                                                                    </div>
                                                                </div>
                                                                <div class="user" title="email@company.com">
                                                                    <img src="http://localhost:8000/img/avatars/sunny.png" alt="demo user"><a href="javascript:void(0);">Joe Cadena</a>
                                                                    <div class="email">
                                                                        joe@company.com
                                                                    </div>
                                                                </div>
                                                                <div class="user" title="email@company.com">
                                                                    <img src="http://localhost:8000/img/avatars/sunny.png" alt="demo user"><a href="javascript:void(0);">Mike McBride</a>
                                                                    <div class="email">
                                                                        mike@company.com
                                                                    </div>
                                                                </div>
                                                                <div class="user" title="email@company.com">
                                                                    <img src="http://localhost:8000/img/avatars/sunny.png" alt="demo user"><a href="javascript:void(0);">Travis Wilson</a>
                                                                    <div class="email">
                                                                        travis@company.com
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="user" title="email@company.com">
                                                                    <img src="http://localhost:8000/http://localhost:8000/img/avatars/sunny.png" alt="demo user"><a href="javascript:void(0);"> Mike McBride</a>
                                                                    <div class="email">
                                                                        mike@company.com
                                                                    </div>
                                                                </div>
